...
function check_for_length_of_extracted_array(array_for_length_verification){
    // console.log(array_for_length_verification)
...
function extract_and_reverse_the_subarray(array_for_reversing){
    ...
    while(j>=0){
        ...
        // console.log(num1)
        // do_the_splicing_operation, i.e., removing the integer from the Array
        for(let i=0;i<array_for_reversing.length;i++){
        
            if(array_for_reversing[i]==num1){            
                array_for_reversing.splice(i, 1)
                // console.log(array_for_reversing)
            }
...
// [Running] node "/home/swaroop/Downloads/JavaScript Coding Challenge/ReverseArrayInGroups.js"
// The given Array is  [
//   1, 2, 3, 4,
//   5, 6, 7, 8
// ]
